...
public final class Constants {
  ...
  public static final class DriveSubsystem {
    ...
    public static final double mult = 0.5;
  }
...
//Auto Constants
public static final double X_REEF_ALIGNMENT_P = 2; //was 2
public static final double Y_REEF_ALIGNMENT_P = 0; //was 4
public static final double ROT_REEF_ALIGNMENT_P = 0; //was 0.5

public static final double ROT_SETPOINT_REEF_ALIGNMENT = 0; //was 0 
public static final double ROT_TOLERANCE_REEF_ALIGNMENT = .5; //was .5
public static final double X_SETPOINT_REEF_ALIGNMENT = -.04; //was -.04
public static final double X_TOLERANCE_REEF_ALIGNMENT = .005; //was .005
public static final double Y_SETPOINT_REEF_ALIGNMENT = .67; //was .67
public static final double Y_TOLERANCE_REEF_ALIGNMENT = .1; //was .005

public static final double DONT_SEE_TAG_WAIT_TIME = 1; //was 1
public static final double POSE_VALIDATION_TIME = 2; //Drastically Adjust //was 2
}
